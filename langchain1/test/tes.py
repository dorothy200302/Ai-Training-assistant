...
def generate_questions(text: str) -> List[str]:
    llm = ChatOpenAI(model="gpt-4o-mini", temperature=0, api_key='as-D73mmid1JVABYjxT4_ncuw',
...
def parse_args():
    ...
    parser.add_argument('--path', type=str,
                        default=r'C:\Users\dorot\PycharmProjects\langchain1\.venv\share\阿里巴巴对工作岗位的要求 - 百度文库.pdf',
...
if __name__ == "__main__":
    ...
    query = "according to the document, create a outline of induction document for employee training"
    ...
    outline=retrieved_docs[0].content
    # Further query example
    query = f"according to the document and the outline{outline}, create  specific content  of induction document for employee training"
