...
class Visualized_BGE(nn.Module):
    ...
    def encode(self, image=None, text=None):
        ...
        if image is not None:
            ...
            if text is not None:
                text = self.tokenizer(text, return_tensors="pt", padding=True, truncation=True,max_length=512)
    ...
    def encode_image(self, images):
        ...
        prompts = self.tokenizer(prompts, return_tensors="pt", padding=True,truncation=True,max_length=512)
