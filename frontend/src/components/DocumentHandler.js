...
const DocumentHandler = ({ documentTitle, documentContent, onUpload, uploadEndpoint, className }) => {
    ...
    return (_jsxs("div", { className: className, children: [uploadEndpoint && (_jsx(DocumentUpload, { onUpload: onUpload, endpoint: uploadEndpoint, isUploading: isUploading, setIsUploading: setIsUploading })), _jsxs("div", { className: "flex gap-2 mt-4", children: [_jsxs(Button, { onClick: () => handleDownload('pdf'), disabled: isDownloading || !documentContent, children: [isDownloading ? (_jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" })) : (_jsx(FileDown, { className: "mr-2 h-4 w-4" })), "\u4E0B\u8F7DPDF"] }), _jsxs(Button, { onClick: () => handleDownload('docx'), disabled: isDownloading || !documentContent, variant: "outline", children: [isDownloading ? (_jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" })) : (_jsx(FileDown, { className: "mr-2 h-4 w-4" })), "\u4E0B\u8F7DDOCX"] })] })] }));
};
